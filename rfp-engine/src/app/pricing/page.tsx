    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {(cancelled || purchaseCancelled) && (
          <div className="mb-8 p-4 bg-warning/20 border border-warning rounded-lg text-center">
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-foreground">Monthly Subscriptions</h2>
          <p className="mt-2 text-muted-foreground">For regular RFP responders - cancel anytime</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {plans.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                className={`relative rounded-2xl bg-card p-8 shadow-sm border-2 transition-shadow hover:shadow-lg flex flex-col ${
                  plan.popular ? "border-primary gradient-border" : (isCurrent && !planLoading) ? "border-success" : "border-border"
                }`}
              >
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-foreground">Just need one RFP?</h2>
            <p className="mt-2 text-muted-foreground">Pay once, no subscription required</p>
          </div>
          <div className="max-w-md mx-auto">
            <div className="relative rounded-2xl bg-pill-orange/30 p-8 shadow-sm border-2 border-pill-orange hover:shadow-lg transition-shadow">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                <Badge variant="orange">One-Time Purchase</Badge>
              </div>

              <div className="text-center">
                <h3 className="text-lg font-semibold text-foreground">{singleUsePlan.name}</h3>
                <div className="mt-4 flex items-baseline justify-center gap-1">
                  <span className="text-4xl font-bold text-foreground">${singleUsePlan.price}</span>
                  <span className="text-muted-foreground">{singleUsePlan.period}</span>
                </div>
                <p className="mt-2 text-sm text-muted-foreground">{singleUsePlan.description}</p>
              </div>
        ...
        <div className="mt-20 text-center">
          ...
          <div className="mt-8 max-w-3xl mx-auto grid gap-6 text-left">
            <div className="p-6 bg-muted/30 rounded-lg border">
              <h3 className="font-semibold text-foreground">Can I change plans later?</h3>
        ...
        {/* CTA */}
        <div className="mt-20 text-center p-12 gradient-hero-subtle rounded-2xl border border-primary/20">
          <h2 className="text-2xl font-bold text-foreground">
